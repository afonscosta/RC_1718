...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{Conex�o com a rede local mantida, com o exterior perdida.}
	\label{fig:r_s}
\end{figure}
...
Adicione as rotas est�ticas necess�rias para restaurar a conectividade para	o servidor S1, por forma a contornar a restri��o imposta na	al�nea c). Utilize para	o efeito o comando route add e registe os comandos que usou.

Teste a	nova pol�tica de encaminhamento garantindo que o servidor est� novamente acess�vel,	utilizando para	o efeito o comando ping. Registe a nova	tabela de encaminhamento do servidor.

\subsubsection{Resposta}\rule[-10pt]{0pt}{10pt}\\
Foram adicionadas as rotas correspondentes aos comandos: \textbf{route add -net 10.0.6.0 netmask 255.255.255.0 gw 10.0.9.1} , \textbf{route add -net 10.0.7.0 netmask 255.255.255.0 gw 10.0.9.1} , \textbf{route add -net 10.0.8.0 netmask 255.255.255.0 gw 10.0.9.1} . Estas rotas foram adicionadas de forma a que a conex�o entre departamentos fosse restabelecida, uma vez que se registou o destinat�rio de cada um e se implicou a resposta atrav�s do \textit{gateway} do departamento Rd.

� poss�vel ver o processo de retirada da \textit{route} 0.0.0.0 (default) e adi��o das est�ticas correspondentes a cada um dos departamentos.

\subsubsection{Realização}\rule[-10pt]{0pt}{10pt}\\
\begin{figure}
	\begin{center}
	\includegraphics[scale=0.35]{./imagens/restauro.png} 
	\end{center}
	\caption{\label{fig:packet_third}A conex�o � restabelecida com a nova tabela de reencaminhamento.}
\end{figure} 
