...
Imprima o segundo fragmento do datagrama IP original. Que informação do cabeçalho IP indica que não se trata do 1Âº fragmento? Há mais fragmentos? O que nos permite afirmar isso?
...
Execute o comando netstat Â¿rn por forma a poder consultar a tabela de encaminhamento unicast (IPv4). Inclua no seu relatório as tabelas de encaminhamento obtidas; interprete as várias entradas de cada tabela. Se necessário, consulte o manual respetivo ( man netstat ).
...
\begin{figure}
	...
	\end{center}
	\caption{\label{fig:packet_third}A conexão é restabelecida com a nova tabela de reencaminhamento.}
\end{figure} 
