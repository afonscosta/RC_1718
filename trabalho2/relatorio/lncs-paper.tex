...
A m·scara da rede IP È 255.255.0.0 , sendo a m·scara para cada subrede 255.255.255.0 . Isto permite-nos 8 bits para endereÁar os \textit{hosts} de cada departamento. Como os \textit{hosts} 172.16.x.0 e 172.16.x.255 est„o reservados como o identificador da rede e acesso de \textit{broadcast}, respetivamente, dispomos de 2^8 - 2 = 254 \textit{hosts} por departamento. 
...
%Confirma-se que se pode fazer ping de cada subrede se pode ligar a cada uma das outras subredes locais.
%¿s tantas ponho sÛ imagens aqui.

\subsubsection{RealizaÁ„o}\rule[-10pt]{0pt}{10pt}\\ %Depois se calhar retira-se este
